...
///
/// Files are stored under `STEEL_STORAGE_LOCAL_DIR` (default: `./uploads`).
...
impl LocalStorage {
    ...
    /// Create from env var `STEEL_STORAGE_LOCAL_DIR`, defaulting to `./uploads`.
    pub fn from_env() -> Self {
        let dir =
            std::env::var("STEEL_STORAGE_LOCAL_DIR").unwrap_or_else(|_| "./uploads".to_string());
