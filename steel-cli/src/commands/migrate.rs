...
fn generate_create_table_sql(resource: &steel_core::ResourceDefinition) -> String {
    ...
    for (name, schema) in &resource.schema {
        let sql_type = match &schema.field_type {
            steel_core::FieldType::Uuid => "UUID",
            steel_core::FieldType::String => "TEXT",
            steel_core::FieldType::Integer => "INTEGER",
            steel_core::FieldType::Bigint => "BIGINT",
            steel_core::FieldType::Number => "DOUBLE PRECISION",
            steel_core::FieldType::Boolean => "BOOLEAN",
            steel_core::FieldType::Timestamp => "TIMESTAMPTZ",
            steel_core::FieldType::Date => "DATE",
            steel_core::FieldType::Enum => "TEXT",
            steel_core::FieldType::Json => "JSONB",
            steel_core::FieldType::Array => "JSONB",
            steel_core::FieldType::File => "TEXT",
        };
        ...
        if schema.generated && schema.field_type == steel_core::FieldType::Uuid {
            col.push_str(" DEFAULT gen_random_uuid()");
        }
        if schema.generated
            && (schema.field_type == steel_core::FieldType::Timestamp
                || schema.field_type == steel_core::FieldType::Date)
        {
